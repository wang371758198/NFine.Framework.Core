var UI = {
    init: function() {
        ...
        $("#bar_fill").button({
            onMousedown: function() {
                ...
                $("#bar_fill_gradient").unbind().bind("click",
                function() {
                    Designer.setFillStyle({
                        type: "gradient"
                    });
                ...
                $("#bar_fill_img").unbind().bind("click",
                function() {
                ...
                $("#bar_fill_more").unbind().bind("click",
                function() {
        ...
        $("#menu_bar").children().bind("mousedown",
        function(i) {
            var h = $(this);
            b(h);
            i.stopPropagation()
        });
        $("#menu_bar").children().bind("mouseenter",
        function() {
            var h = $(this);
        ...
        c.css("right", "-179px");
        c.children(".color_items").children("div").unbind().bind("click",
        function() {
        ...
        c.children(".color_items").children("div").off("mouseenter").on("mouseenter",
        function() {
            var h = $(this).css("background-color");
            h = h.replace(/\s/g, "");
            h = UI.RGB2Hex(h);
        ...
        c.children(".color_hex").find("input").off("keyup").on("keyup",
        function() {
            var i = $(this).val();
        ...
        c.children(".color_transparent").bind("click",
        function() {
            Designer.setPageStyle({
    ...
    showImageSelect: function(d) {
        ...
        $(".image_sources").children().unbind("click").bind("click",
        function() {
    ...
    loadSearchImg: function() {
        $.getJSON("https://api.iconfinder.com/v2/icons/search?query=" + this.searchKeywords + "&offset=" + this.searchIndex + "&count=24&minimum_size=128&vector=false&premium=false",
        function(c) {
            if (c.total_count == 0) {
    ...
    getCollaTeamMembers: function() {
        Util.ajax({
            ...
            success: function(a) {
                ...
                $(".colla_suggest").find("li").on("click",
                function() {
                        ...
                        if (!$(this).hasClass("active")) {
                            ...
                            Util.ajax({
                                ...
                                success: function(i) {
                                    ...
                                    $(".colla_suggest.team_member").find("li").on("click",
                                    function() {
                                        $("#add_prompt4").hide();
                                        $("#add_prompt3").hide();
                                        $("#add_prompt2").show();
    ...
    showShapeOptions: function() {
        ...
        function h(q, w) {
            ...
            if (p.length == 0) {
                ...
                p.children(".dlg_close").bind("click",
                function(i) {
                    p.hide()
                })
            }
    ...
    showTip: function(a, d, c) {
        ...
        if (b.length == 0) {
            ...
            b.children(".ui_tip_close").bind("click",
            function() {
                UI.hideTip()
            })
        }
        if (c) {
            b.children(".ui_tip_close").bind("click.callback",
            function() {
                c()
            })
        } else {
...
var Dock = {
    init: function() {
        ...
        $(".dock_page_ori_list").children("input").unbind().bind("click",
        function() {
            var f = $(this).val();
            Designer.setPageStyle({
                orientation: f
    ...
    initRemoveHistory: function() {
        function a() {
            $(".dock_history_remove_div").find("span:first").off().on("click",
            function(c) {
            ...
            $(".dock_history_remove_div").find("span:last").off().on("click",
            function(b) {
                $(".dock_history_remove_con").remove();
                b.stopPropagation()
            })
        }
        $(".dock_history_remove").off().on("click",
        function(f) {
            $(".dock_history_remove_con").remove();
    ...
    openHistory: function(a) {
        if (this.currentDefinition == null) {
            this.currentDefinition = $.extend(true, {},
            Model.define)
        }
        Utils.unselect();
        Designer.open(a);
    ...
    bindComment: function() {
        ...
        a.find("input").unbind("click").bind("click",
        function(b) {
            b.stopPropagation()
        });
        a.find(".input_comment_reply").unbind("keydown").bind("keydown",
        function(d) {
            if (d.keyCode == 13) {
                var c = $(this).val();
                if (c == "") {
        ...
        a.find(".comment_remove").unbind("click").bind("click",
        function(g) {
            g.stopPropagation();
            $(this).parent().remove();
        ...
        a.children(".comment_item_outer").unbind().bind("click",
        function() {
            if ($(this).hasClass("selected")) {
...
var ProShare = {
    publish: {
        ...
        execute: function(e) {
            ...
            $("#pubpo_win").on("click", "#to_publish_edit",
            function() {
                $(".pubpo-tab").hide();
                $("#publish_topublic").show()
            });
            $("#publish_addtags").on("click",
            function(f) {
                $("#tag_input").focus()
            });
            $("#tag_input").off("keyup.input").on("keyup.input",
            function(g) {
            ...
            }).off("keydown.delete").on("keydown.delete",
            function(f) {
            ...
            $("#tag_items").find(".close-tag").die().live("click",
            function() {
                $(this).parent().remove();
            ...
            $("#btn_submit_publish").off().on("click",
            function() {
                var g = "verifying";
            ...
            $("#btn_submit_private").off().on("click",
            function() {
                var f = "private";
                b(f)
            });
    ...
    viewlink: {
        ...
        execute: function(j) {
            ...
            $(".share_to_a").off("mousedown").on("mousedown",
            function(l) {
                l.stopPropagation();
                var k = $(this);
                Util.ajax({
                    ...
                    success: function(p) {
                        if (p.viewLinkId != "") {
                            ...
                            if (k.hasClass("weixin")) {
                                ...
                                $(document).off("mousedown.weixin").on("mousedown.weixin",
                                function() {
                                    m.remove()
                                })
                            } else {
            ...
            function a() {
                $(".dlg-content .create").text("创建链接").off().on("click",
                function() {
                    d()
                }).next().hide().next().hide();
                $(".share-menu").hide();
            ...
            function g(k) {
                $(".dlg-content .create").text("删除链接").off().on("click",
                function() {
                    f()
        ...
        execute: function(a) {
            Util.ajax({
                ...
                success: function(c) {
                    ...
                    $("#img_link_input").val(b).off().on("click",
                    function() {
                        $(this).select();
                        try {
                            if (document.execCommand("copy", false, null)) {
...
var collaboration = {
    ...
    init: function(c, b) {
        ...
        $(".colla-context-con").on("click", ".colla-follow-more",
        function(f) {
        ...
        $(document).on("click", ".colla-user, .colla-team-user > div",
        function(f) {
            var d = $(this).attr("uid"),
            g = $(this).text();
        ...
        $("#send-colla-invite").off().on("click",
        function(h) {
            var g = $("#colla_add"),
            d = $("#multi-input");
            if (d.length > 0 && d.val() != "") {
    ...
    c.colorpicker = function(f) {
        ...
        e.dropdown(g);
        e.children(".color_items").children("div").unbind().bind("click",
        function() {
            if (f.onSelect) {
                var h = c(this).css("background-color");
                h = h.replace(/\s/g, "");
        ...
        e.children(".color_items").children("div").off("mouseenter").on("mouseenter",
        function() {
            var h = c(this).css("background-color");
            h = h.replace(/\s/g, "");
            h = UI.RGB2Hex(h);
        ...
        e.children(".color_hex").find("input").off("keyup").on("keyup",
        function() {
            var i = c(this).val();
            if (i.length == 3 || i.length == 6) {
                var h = UI.hex2RGB("#" + i);
