...
var CLB = {
    ...
    init: function() {
        var b = this,
        a = "";
        var c = sessionStorage.getItem("flowclient_" + chartId);
        if (c == null || c == "") {
            a = new Date().valueOf();
		...
		var d ={"users":[{"client":"1513238585652","subject":"58367b42e4b0620292ca1fef","uname":"58367b03e4b0620292ca1c15","userId":"58367b03e4b0620292ca1c14","name":"王俊桥-阑途信息"}],"uk":"58367b03e4b0620292ca1c14"}
                b.collaUsers = d.users;
                b.collaClient = a;
                b.collaUk = d.uk;
                b.collaItv = null;
